...
class UltraUsernameClaimer:
    def __init__(self):
        ...
        # بيانات الجلسة للتسجيل التلقائي - تم التحديث بالجلسة الجديدة
        self.session_string = "1BJWap1sAUGwnF8P9WkS6gRFB40L2-3gub8uQRIpaFSfO6xpzEHoKGcTvwSYU12PTVbkhu2z6NInz6IdszFQACC1uJMb7rHLYbsPiKDAEKxAq1Yu6h35X-qlIuZVXOTYRk_CKtRC50B1ygrt0iLiU4xgN7K5_1IWitKz66QujO6ZpC-A53iMSe5vPmTHUpoLcPbJ6ubmiIPhnaZFZd3zi_fZpI7grenPE5K8W4ociP8fXUZyasqvNckWUEHn2Cf2HKlt4f_-OjfcopxrSBa858HZ61CoBlVBSdLe2oww44QYb3QcWsbOAPsSH8smNZsg-UVapI5i4HUzTnpXUyZ6Kw1oAIO733Yg="
    ...
    async def auto_login_with_session(self):
        ...
        try:
            ...
            # استخدام الجلسة مباشرة بدون فك تشفير
            ...
            # التحقق من اتصال الجلسة
            if not self.client.is_connected():
                print(f"{Colors.RED}❌ فشل في الاتصال باستخدام الجلسة{Colors.RESET}")
                return False
            ...
            try:
                ...
                print(f"{Colors.GREEN}✅ تم الانضمام إلى قناة المطور{Colors.RESET}")
            except Exception as e:
                print(f"{Colors.YELLOW}⚠️  لم أتمكن من الانضمام إلى قناة المطور: {e}{Colors.RESET}")
